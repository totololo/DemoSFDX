({
    ...
    onSelection : function(component,event,helper){
        if(JSON.stringify(component.get("v.selectedRecord")) != 'null'
    ...
    onblur : function(component,event,helper){
        /*alert(JSON.stringify(component.get("v.selectedRecord")));
        alert(String(component.get("v.SearchKeyWord")));
        alert(String(component.get("v.listOfSearchRecords")));*/
